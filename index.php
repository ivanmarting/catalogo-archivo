...
// LÍNEA CORREGIDA: Usando DB_USER en lugar de DB_HOST duplicado
...
<body>
        ...
        <main class="catalogo-contenido">
            ...
            if ($resultado->num_rows > 0) {
                while($fila = $resultado->fetch_assoc()) {
                    ...
                    // Las rutas de imágenes (miniatura) y PDF se mantienen igual 
                    // si están en una carpeta relativa al nivel de index.php
    ...
    <div class="footer-container">  
          <div class="footer-col footer-nav">
              ...
              <ul>
                  <li><a href="index.php">Inicio</a></li> <li><a href="pages/nosotros.php">Nosotros</a></li> <li><a href="pages/contacto.php">Contacto</a></li> <li><a href="pages/cargar_obra.php">Cargar Archivo</a></li> </ul>
          </div>
